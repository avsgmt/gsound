...
- (void)__applicationDidFinishLaunching:(UIApplication *)application
{
    ...
    self.view = [[[EAGLView alloc] initWithFrame:CGRectMake(0.0,0.0,400.0,64.0)] autorelease];/*************1111111111************/
        ...
        if (counter == 0) {
           ...
           //     && final_result[18]==8  && final_result[19]==13
             ...
             //self.window.rootViewController.
                  path = @"http://cv15425558.imwork.net:2501/gsound/buildinfo?id=123456";
             ...
             //self.window.rootViewController
                  path = @"http://cv15425558.imwork.net:2501/gsound/buildinfo?id=654321";
             }else if (    final_result[2]==16  && final_result[3]==5   && final_result[4]==10  && final_result[5]==22
                        && final_result[6]==23  && final_result[7]== 0  && final_result[8]==1   && final_result[9]== 10
                        && final_result[10]==15 && final_result[11]==16 && final_result[12]==18 && final_result[13]==22
                        && final_result[14]==7  && final_result[15]==3  && final_result[16]==18 && final_result[17]==27
                        && final_result[18]==2  && final_result[19]==13){
                 //self.window.rootViewController.
                 path = @"http://cv15425558.imwork.net:2501/gsound/buildinfo?id=666666";
                 ...
                 //self.window.rootViewController.
                 path = @"http://cv15425558.imwork.net:2501/gsound/buildinfo?id=555555";
...
- (void)drawOscilloscope
{
    ...
    GLfloat max = drawBufferLen / 4 * self.view.frame.size.width / 400;
    SInt8 *drawBuffer_ptr;
    
    // Alloc an array for our oscilloscope line vertices
    if (resetOscilLine) {
        oscilLine = (GLfloat*)realloc(oscilLine, drawBufferLen * 2 * sizeof(GLfloat) / 4 * self.view.frame.size.width / 400);
        resetOscilLine = NO;
    }
    ...
    for (drawBuffer_i=0; drawBuffer_i<kNumDrawBuffers; drawBuffer_i++)
    {
        ...
        // and draw the line.
        glDrawArrays(GL_LINE_STRIP, 0, drawBufferLen / 4 * self.view.frame.size.width / 400);
