...
public class AudioPlayer {
    ...
    public boolean play(float[] audioData, int offsetInBytes, int sizeInBytes) {
        ...
        //put the data into audioTrack,and then play
        if (mAudioTrack.write(audioData, offsetInBytes, sizeInBytes, WRITE_BLOCKING) != sizeInBytes) {
